...
namespace UnitOfWorkApplication.Infrastructure
{
    public class CalculateDistance
    {       
        public void GetCurrentCityCoordinates(float latitude, float longitude)
        {
            var coordinareFiles = Directory.GetFiles(@"C:\Users\akhil\Documents\Visual Studio 2015\Projects\RedCabsWebAPI\UnitOfWorkApplication.Infrastructure\Coordinates\");
